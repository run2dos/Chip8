...
class Debugger:
    def __init__(self, chip):
        ...
        label_value4 = Label(inner_frame, text='000').grid(row=4, column=1)
        label_value5 = Label(inner_frame, text='000').grid(row=5, column=1)
        label_value6 = Label(inner_frame, text='000').grid(row=6, column=1)
        label_value7 = Label(inner_frame, text='000').grid(row=7, column=1)
        label_value8 = Label(inner_frame, text='000').grid(row=8, column=1)
        label_value9 = Label(inner_frame, text='000').grid(row=9, column=1)
        label_valueA = Label(inner_frame, text='000').grid(row=10, column=1)
        label_valueB = Label(inner_frame, text='000').grid(row=11, column=1)
        label_valueC = Label(inner_frame, text='000').grid(row=12, column=1)
        label_valueD = Label(inner_frame, text='000').grid(row=13, column=1)
        label_valueE = Label(inner_frame, text='000').grid(row=14, column=1)
        label_valueF = Label(inner_frame, text='000').grid(row=15, column=1)
        ...
        label_SP_value = Label(rinner_frame, text='000').grid(row=0, column=1)

        label_PC = Label(rinner_frame, text='PC:')
        label_PC.grid(row=1, column=0)
        label_PC_value = Label(rinner_frame, text='000').grid(row=1, column=1)

        label_opcode = Label(rinner_frame, text='Opcode:')
        label_opcode.grid(row=2, column=0)
        label_opdocd_value = Label(rinner_frame, text='000').grid(row=2, column=1)

        label_cycle = Label(rinner_frame, text='Cycle:')
        label_cycle.grid(row=3, column=0)
        label_cycle_value = Label(rinner_frame, text='000').grid(row=3, column=1)
